...
if hosts.platform !~ /debian-7-amd64/
  describe 'install_puppet_6_agent.sh with no arguments' do

    describe command('bash -c "/var/tmp/puppet-install-shell/install_puppet_6_agent.sh"') do
      if os[:family] == 'redhat'
